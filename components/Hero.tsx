      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8 ">
          <div className="inline-flex relative">
            <h1 className="text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex">
              Gamify Healthy <br /> Habits
            </h1>
            <motion.div
              className="ml-48 mt-20 absolute left-[498px] top-[56px] hidden sm:inline"
              drag
              dragSnapToOrigin
            >
              <Image
        ...
        <div className="flex justify-center">
          <p className="text-xl text-center mt-8 max-w-md">
            FitSphere helps prevent lifestyle diseases by encouraging healthy
            habits through gamification. Users join groups, set health goals,
            and compete to achieve them.
          </p>
        </div>
        <div className="flex justify-center mt-8">
